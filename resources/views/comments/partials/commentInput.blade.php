      ...
      <div class="row mt-4">
          <div class="col-md-12">
              <form action="{{ route('comments.store', $post) }}" method="POST" enctype="multipart/form-data"
                  style="background-color: #141A29;;color: #3ABEFE; border: 1px solid #3ABEFE; border-radius: 20px; padding-top: 30px; padding-right: 30px; padding-left: 30px;"
                  x-data="{ media: '', video: '', location: '', friends: [] }" class='w-100'>
                  @csrf
                  <div class=" w-100">
