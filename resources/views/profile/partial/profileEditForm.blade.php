<div class="card" style='background-color: #1A2235;'>
    <div class="card-body">
        <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-md-12 mt-2">
                    <input
                        style="background-color: #0E121C; color: white ;border:none; border-radius: 20px; padding: 10px"
                        id="address" type="text" class="form-control @error('address') is-invalid @enderror"
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-12">
                        <input
                            style="background-color: #0E121C; color: white ;border:none; border-radius: 20px; padding: 10px"
                            id="age" type="text" class="form-control @error('age') is-invalid @enderror"
                    ...
                    <div class="col-md-12 mt-2">
                        <input
                            style="background-color: #0E121C; color: white ;border:none; border-radius: 20px; padding: 10px"
                            id="gender" type="text" class="form-control @error('gender') is-invalid @enderror"
                ...
                <center>
                    <button type="submit" class="btn btn-primary"
                        style="background-color: #183375; color: white ;border:none; border-radius: 20px; padding: 10px; margin:20px; padding: 10px; width: 90%">
                        {{ __('Update') }}
                    </button>
                </center>
        </form>
